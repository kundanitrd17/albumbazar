          ...
          <form role="form" action="add-association" method="post">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <input type="text" name="name" placeholder="Enter Asociation Name" class="form-control required" />
              </div>
              <div class="form-group">
                <label>Contact 1 <span>*</span></label>
                <input type="text" name="contact1" placeholder="Enter Branch Code " class="form-control required" />
                <div class="form-group">
                  <label>Contact 2 <span>*</span></label>
                  <input type="text" name="contact2" placeholder="Phone" class="form-control required" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="container-fluid">
                <div class="row form-inline">
                  <div class="form-group col-md-5 col-xs-5">
                    ...
                    <input type="date" name="startDate" placeholder="Contract Start Date " class="form-control" />
                  </div>
                </div>
              </div>
