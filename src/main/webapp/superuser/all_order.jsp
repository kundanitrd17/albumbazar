        ...
        <%@include file="header.jsp" %>
          ...
          <div class="container">
            ...
            <div class="row" style="margin-bottom: 20px;">
              <div class="form-group col-12 col-sm-12 col-xs-12 col-md-4 col-xl-4 col-lg-4 "></div>
              <form id="branchSelectDropdown" action="/superuser/order-list" method="GET"
                class="form-group col-12 col-sm-12 col-xs-12 col-md-4 col-xl-4 col-lg-4 ">
                <label for="sel1" style="color: aliceblue;">Select Branch:</label>
                <select name="branch_code" class="form-control">
                  <option value="">All</option>
                  <c:forEach items="${branchCodeAndName}" var="branch">
                    <option value="${branch.branchCode}">${branch.name}</option>
                  </c:forEach>
                </select>
              </form>
            </div>
