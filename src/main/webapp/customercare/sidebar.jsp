<aside class="side-nav" id="show-side-navigation1">
    ...
    <ul class="categories">
        ...
        <li><i class="fa fa-home fa-fw">
            </i><a href="/customer-care">Home</a>
        </li>

        <li><i class="fa fa-support fa-fw">
            </i><a href="/customer-care/order-pool">Order Pool</a>
        </li>

        <li><i class="fa fa-home fa-fw">
            </i><a href="/customer-care/accepted-order">Accepted Orders</a>
        </li>
