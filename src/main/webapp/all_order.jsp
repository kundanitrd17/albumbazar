      ...
      <table class="table " style="font-size: 12px;">
        <thead>
          <tr class="filters">
            ...
            <th><input type="text" class="form-control" placeholder="Cover Page" disabled></th>
             ...
             <th colspan="2" style="text-align: center;"><a class="btn btn-success" href="add-branch.html">Accepted Order</a></th>
          </tr>
        </thead>
        <tbody>
          <tr>
