...
<html>
  ...
  <body>
                ...
                <tr class="filters">
                  ...
                  <th colspan="2" style="text-align: center">
                    <a
                      ...
                      href="/association/order-list/new-arrived-order"
                      >Arrived Order</a
                    >
                  </th>
                </tr>
              ...
              <tbody>
                <c:forEach items="${allOrders}" var="eachOrder">
                  <tr id="orderRow${eachOrder.id}">
                    <td class="orderId" data-order-id="${eachOrder.id}">
                      ${eachOrder.uuid}
                    </td>
                    ...
                    <td>
                      <a
                        ...
                        id="link_address"
                        onclick="fetchAddress('${eachOrder.deliveryAddress.id}')"
                        >Address Id</a
                      >
                    </td>
                    ...
                    <td>
                      ...
                      <button
                        ...
                        onclick="associationWorkCompleted('${eachOrder.id}')"
                      >
                        Work Done
                      </button>
                    </td>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class=""> <a href="#" class="btn btn-success saveCover "
                                                style="display: none;" onclick="saveCoverFun(1)">Save</a>
                                            <button class="btn btn-warning editCover">Edit</button>
                                        </td>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class=""> <a href="#" class="btn btn-success savePage "
                                                style="display: none;" onclick="savePageFun(1)">Save</a>
                                            <button class="btn btn-warning editPage">Edit</button>
                                        </td>
    ...
    <script
      type="text/javascript"
      src="http://localhost:8080/association/js/under_process_association.js"
    ></script>
    ...
    <script type="text/javascript">
      ...
      $(".table tbody tr td").on("click", ".e-icon", function () {
        ...
        $(this)
          .parent()
          .siblings("#associationName")
          .attr("contenteditable", "true")
          .focus();
        $(this)
          .parent()
          .siblings("#associationPhone1")
          .attr("contenteditable", "true")
          .focus();
        $(this)
          .parent()
          .siblings("#associationPhone2")
          .attr("contenteditable", "true")
          .focus();
        $(this)
          .parent()
          .siblings("#associationEmail")
          .attr("contenteditable", "true")
          .focus();
      });
      ...
      $(".table tbody tr td").on("click", ".u-icon", function () {
        ...
        $(this)
          ...
          .attr("contenteditable", "true")
          .focus()
          .css({ "background-color": "#eeeeee", width: "200px" });
      });
