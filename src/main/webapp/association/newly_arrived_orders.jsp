...
<html>
  ...
  <body>
                ...
                <tr class="filters">
                  ...
                  <th colspan="2" style="text-align: center">
                    <a
                      ...
                      href="/association/order-list/processing"
                      >View Accepted Order
                    </a>
                  </th>
                </tr>
                  ...
                  <tr id="orderRow${eachOrder.id}">
                    ...
                    <td id="OrderDescription">
                      <button
                        ...
                        class="btn"
                        data-toggle="modal"
                        data-target="#DescriptionCard${eachOrder.id}"
                      >
                        Show Description
                      </button>
                    ...
                    <td id="OrderPageDetails">
                      <a class="btn">Show Pages Detail</a>
                    </td>
                    ...
                    <td>
                      <a
                        class="btn btn-danger accept-order-icon"
                        onclick="acceptOrderByAssociation('${eachOrder.id}')"
                        >Accept Order</a
                      >
                    </td>
                  </tr>
    ...
    <script
      type="text/javascript"
      src="http://localhost:8080/association/js/new_order.js"
    ></script>
