<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
        ...
        <%@include file="navbar.jsp" %>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${deliveries}" var="delivery">
                                <tr class="delivery-row" id="deliveryRow${delivery.order_id}">
                                    ...
                                    <td>
                                        <button onclick="setDeliveryUnderProcess('${delivery.order_id}')"
                                            class="btn btn-primary">Send Under-Process</button>
                                    </td>
                                </tr>
            ...
            <script src="http://localhost:8080/delivery/js/delivery.js"></script>
