...
insert into association(id, active, contact1, contact2, email, name, password) values(1, true, "8918918991", "9821380120", "harsh", "harsh", "abc");
...
insert into employee(name, email, password, joining_date, personal_contact, role, branch_id) VALUES("harsh", "prince", "abc", "2020-10-10", "243", "ROLE_CUSTOMER_CARE", "1");
...
insert into employee(name, email, password, joining_date, personal_contact, role, branch_id) VALUES("moon", "moon", "abc", "2020-10-10", "98372342380", "ROLE_ADMIN", "1");
...
insert into customer (id, active, email, password) values(1, 1, "nishigupta726@gmail.com", "abc");
