...
public enum OrderDetailStatus {
    ...
    UNDER_PROCESS_BY_ASSOCIATION(Code.UNDER_PROCESS_BY_ASSOCIATION), READY_TO_DELIVER(Code.READY_TO_DELIVER),
    SENT_TO_DELIVERY_PARTNER(Code.SENT_TO_DELIVERY_PARTNER), DELIVER(Code.DELIVER),
